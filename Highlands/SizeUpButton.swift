...
class SizeUpButton: UIButton {
    ...
    override func drawRect(rect: CGRect) {
        ...
        let roundedRectPath = UIBezierPath(roundedRect: CGRect(x: 1, y: 1, width: self.frame.width - 2, height: self.frame.height - 2), byRoundingCorners: [UIRectCorner.TopLeft, UIRectCorner.BottomLeft] , cornerRadii: CGSize(width: 6, height: 6))
